  ...
  <div class="game-container">
    ...
    <main>
      <div class="game-info">
        ...
        <div class="combo-display" v-if="combo > 1">{{ combo }}连击! 🎉</div>
      </div>
      ...
      <div class="game-controls">
        ...
        <div class="control-methods">
          <div class="control-item">
            <strong>游戏玩法</strong>
            <p>点击选择一个动物，再点击相邻动物交换</p>
          </div>
          <div class="control-item">
            <strong>消除规则</strong>
            <p>3个或更多相同动物连成一线即可消除</p>
          </div>
        </div>
      </div>
      <div class="game-rules">
        <h3>游戏规则</h3>
        <ul>
          <li>交换相邻两个动物形成3个或更多连线</li>
          <li>消除后上面的动物掉落，新动物补充</li>
          <li>连击获得额外分数！无限玩挑战最高分！</li>
        </ul>
      </div>
    </main>
    <footer><p>经典消除游戏 - 动物消消乐</p></footer>
  </div>
</template>
<script setup>
